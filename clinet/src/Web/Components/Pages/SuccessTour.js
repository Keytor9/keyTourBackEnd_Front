          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <div className="booking-details-id">
                ...
                <div className="">
                  <h3>From</h3>
                  <span>{destinations?.data.availability.from}</span>
                  <h3>To</h3>
                  <span>{destinations?.data.availability.to}</span>
                </div>
                <Link
            ...
            <div className="col-md-6">
              <div className="booking-des">
                <h2>Description</h2>
                <p>{destinations?.data.brief.en}</p>
                ...
                <p>{destinations?.data.cancellation_policy.en}</p>
              </div>
            </div>
