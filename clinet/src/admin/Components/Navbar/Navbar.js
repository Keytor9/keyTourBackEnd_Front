...
import Admin from "../Assets/img/Frame 35587.png";
...
function Navbar(props) {
  ...
  const handleLogout = async () => {
    try {
      ...
      //   {
      //     headers: {
      //       role: 'admin', // Add the role in headers
      //     },
      //   }
      // );
  ...
  return (
    <div className="navbar">
      <div className="navbar-details">
        ...
        <Link to="/Admin_Profile" className="profile-button">
          {/* <img src={Admin} alt="Admin Photo" className="admin-photo" /> */}
          <h2>{name}</h2>
        </Link>
        <a
