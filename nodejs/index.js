...
//       interaction: {
//         returnUrl:`http://185.170.198.81/api/payment-callback?orderId=${orderId}`,
//         operation: 'PURCHASE',
...
app.get('/aaa', async (req, res) => {
  ...
  const notificationToSend = {
    token: 'csEVRSCATN2FTtkZo9F7wE:APA91bFgDguWjHGMktKej5T1h3nd_6WwrIDEdNn2RCuJb5iuX1bnkfDmQffrt_54nBx6GSd-ZPG-NJl4b_Z5nhrGhLidvz5oEHdM8RSGCSi1d8l9TJfyu-g',
...
if (booking.user!=userId) 
    {
      ...
      const data = {
        ...
        returnUrl: `http://185.170.198.81/api/payment-callback?orderId=${orderId}`,  // Dynamic callback URL with orderId
  ...
  // console.log(booking.tour.brief)
      ...
      await Booking.updateOne(
        ...
        { $set: { printurl: `https://test-nbe.gateway.mastercard.com/checkout/pay/${sessionId}?checkoutVersion=1.0.0`,sessionId, successIndicator} }
      );
      // Update the booking document with sessionId and successIndicator
      // booking.sessionId = sessionId;
      // booking.successIndicator = successIndicator;
